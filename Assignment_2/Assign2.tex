...
\\
 \textbf{(i) a vowel }\\
 Number of total letters in the given word is 13. Let S denote the sample space,
 \begin{align} 
 \therefore n(S)=13 
  \end{align}
  
 Let X be the event containing vowels. So, 
 \begin{align}
  X &= \{A,A,A,I,I,O\} \\
  n(X)&=6
 \end{align}
 ...
 \pr X &=\frac{n(X)}{n(S)}\\
    &=\frac{6}{13}
 \end{align}
$\therefore$ The probability that the chosen word is a vowel is $\frac{6}{13}$.
\\ 
 \textbf{(ii) a consonant }\\
 
 Let Y be the event containing vowels. So, 
 \begin{align}
  Y &= \{S,S,S,S,N,T,N\} \\
  n(Y)&=6
 \end{align}
 ...
 \pr Y &=\frac{n(Y)}{n(S)}\\
    &=\frac{7}{13}
 \end{align}
$\therefore$ The probability that the chosen word is a consonant is $\frac{7}{13}$.
